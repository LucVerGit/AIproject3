...
public abstract class FavoriteDummyNeighbourGenerator {

    public static List<Neighbour> FAVORITE_DUMMY_NEIGHBOURS = Arrays.asList(
            new Neighbour(1, "Charlene", "https://i.pravatar.cc/150?u=a042581f4e29026704d", "Saint-Pierre-du-Mont ; 5km",
    ...
    static List<Neighbour> generateNeighbours() {
        return new ArrayList<>(FAVORITE_DUMMY_NEIGHBOURS);
    }
}
